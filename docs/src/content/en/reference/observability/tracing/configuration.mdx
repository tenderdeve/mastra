...
<PropertiesTable
  content={[
  {
    ...
    description: 'Enable default configuration with MastraStorageExporter and MastraObserveExporter',
    required: false,
  },
  {
    name: 'configs',
...
- [MastraStorageExporter](/reference/observability/tracing/exporters/mastra-storage-exporter): Storage configuration
- [MastraObserveExporter](/reference/observability/tracing/exporters/mastra-observe-exporter): Mastra Observe setup
