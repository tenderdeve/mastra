    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            type: 'boolean',
            description:
              'Deprecated. Enables the vnext instruction format, which has been superseded by [Observational Memory](/reference/memory/observational-memory). Use the default stable working memory mode or Observational Memory instead.',
            isOptional: true,
          },
          {
            name: 'readOnly',
