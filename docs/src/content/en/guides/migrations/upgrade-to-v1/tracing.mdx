...
This configuration includes `DefaultExporter`, `MastraObserveExporter`, and `SensitiveDataFilter` processor. See the [observability tracing documentation](/docs/observability/tracing/overview) for full configuration options.
...
1. Use explicit `configs:` with `DefaultExporter`, `MastraObserveExporter`, and `SensitiveDataFilter`
