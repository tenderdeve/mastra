...
If you host your Mastra application on your own infrastructure, you can still send observability data to Studio using the [MastraObserveExporter](/docs/observability/tracing/exporters/mastra-observe).
