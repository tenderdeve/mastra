...
- **Exporters**:
  - `MastraStorageExporter` - Persists traces to your configured storage for Studio
  - `MastraObserveExporter` - Sends observability data to hosted Mastra Studio (requires `MASTRA_CLOUD_ACCESS_TOKEN`)
...
- **[Default](/docs/observability/tracing/exporters/mastra-storage)** - Persists traces to local storage for viewing in Studio
- **[Cloud](/docs/observability/tracing/exporters/mastra-observe)** - Sends observability data to hosted Mastra Studio for production monitoring and collaboration
...
When adding external exporters, include `MastraStorageExporter` and `MastraObserveExporter` to maintain access to Studio:
    ...
    configs: {
      production: {
        ...
        exporters: [
          ...
          new MastraObserveExporter(), // Keep Cloud access
        ],
...
- **MastraObserveExporter** for hosted Studio dashboard
...
- [MastraObserveExporter](/reference/observability/tracing/exporters/mastra-observe-exporter): Mastra platform integration
