...
- **Exporters**:
  ...
  - `MastraObserveExporter` - Sends observability events to Mastra Observe (requires `MASTRA_CLOUD_ACCESS_TOKEN`)
...
- **[Mastra Observe](/docs/observability/tracing/exporters/mastra-observe)** - Sends observability events to Mastra Observe for production monitoring and collaboration
