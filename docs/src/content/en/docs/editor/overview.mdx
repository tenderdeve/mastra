...
- **Run experiments**: Route different users or requests to different agent versions for A/B testing, canary rollouts, or prompt experimentation. See [Rollouts](/docs/agents/rollouts).
...
- Roll out new versions safely with [Rollouts](/docs/agents/rollouts).
